...
const ITEMS: Item[] = [
  ...
  { part: 'I', requirement: 'Validation success state + Apply CTA', status: 'built', where: 'Assign drawer', screen: 'workspace' },
  ...
  // Part J
  { part: 'J', requirement: 'Failure state — "No changes were applied."', status: 'built', where: 'Assign drawer', screen: 'workspace' },
  ...
  { part: 'K', requirement: 'Validation failure — nothing saved, inline error', status: 'built', where: 'Customer drawer', screen: 'workspace', note: 'Set pattern to 2W and pick Tuesday, then Save.' },
